        ...
        >
            <a href="https://shopbop-clone-project.netlify.app/" target="_blank" rel="noreferrer">
                <img
                    ...
                    src="https://i.ibb.co/thcCKst/shopbop.png"
                    alt=""
                />
            </a>
            <div className="p-5">
                <a href="helo">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Shopbop Website Clone
                    </h5>
                </a>
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                    Shopbop-Clone-Project using React and Redux JS.Shopbop is the global online
                    retail destination for style inspiration and discovery, offering women and men
                    a curated selection of ready-to-wear & accessories from over 1,000 established and
                    emerging designers
                </p>
                <a
          ...
          >
            ...
            ></path>
                ...
                <a
                    ...
                    href="https://github.com/amansingh1712/Shopbop-Clone-Project"
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-500 rounded-lg hover:bg-blue-200 focus:ring-4 focus:outline-none focus:ring-blue-300"
                >
